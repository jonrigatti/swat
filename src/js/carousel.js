  ...
  class Carousel extends Component {
    ...
    _scroll(x) {
      ...
      if (this.options.fullWidth) {
        ...
        alignment =
          "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ";
        alignment +=
          "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)";
      ...
      if (!this.noWrap || (this.center >= 0 && this.center < this.count)) {
        ...
        let transformString = `${alignment} translateX(${
          -delta / 2
        }px) translateX(${dir * this.options.shift * tween * i}px) translateZ(${
      ...
      if (!this.noWrap || (this.center >= 0 && this.center < this.count)) {
        ...
        let transformString = `${alignment} translateX(${
          -delta / 2
        }px) translateX(${dir * this.options.shift * tween}px) translateZ(${
          this.options.dist * tween
        }px)`;
        this._updateItemStyle(el, centerTweenedOpacity, 0, transformString);
      }
